// This is the fixed implementation for the getActivities function.
// Copy this entire function and replace the existing one in lead.controller.js
...
const getActivities = asyncHandler(async (req, res, next) => {
  try {
    ...
    const enrichedActivities = activities.map(activity => {
      ...
      // Return enriched activity with the structure expected by frontend
      return {
        ...activity,
        timeAgo,
        activityLabel,
